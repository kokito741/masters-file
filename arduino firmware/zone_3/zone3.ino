 ...
 *  ---------------------------------------------------------------
 *  Zone 3 node firmware   |   ESP32-32U DevKit (38-pin)
 *
 *  Data path:  ESP32 --MQTT/UltraLight2.0--> IoT Agent --> Orion --> Mongo
 *
 *  PIN MAP
 *    GPIO4   DHT11            air temperature + humidity
 *    GPIO21  I2C SDA          DS3231 RTC
 *    GPIO22  I2C SCL          DS3231 RTC
 *    GPIO26  Valve relay      -> wire to IN3 on the shared 4-ch board
 *    GPIO33  YF-B2 flow       via 10k/3k3 divider, interrupt input
 ...
 *
 *  NOTE       - DHT11 here, DHT22 on zones 1 and 2. Whole-degree resolution.
 *
...
#define DEVICE_ID            "zone003"          // matches IoT Agent provisioning
...
#define HAS_DHT         1
#define DHTTYPE        DHT11             // zone 3 sensor; zones 1-2 use DHT22
